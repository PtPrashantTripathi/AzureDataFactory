...
(
    ...
    [parameter(Mandatory = $true)] [String] $EnvName = 'Certification'
)
...
try {
    ...
    if ($envName -ne "Production") {
        Write-Host "════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════"
        Write-Host "Executing script with value of parameter EnvName as: $EnvName, when running this script as Post Deployment, ADF triggers won't be started. Provide value as EnvName = 'Production' when calling this script if you need to start triggers in Post Deployent mode"
        Write-Host "════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════"
    }
